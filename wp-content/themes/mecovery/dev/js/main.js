$(document).ready(function() {
    ...
    //     if ($("section.has-bleed .feature-details-col--img").length) {
    //         var imgHeight = $("section.has-bleed .feature-details-col--img img").height();
    //         $("section.has-bleed .feature-details-col--img").parent(".feature-details-columns").css({ "height": imgHeight });
    //     }
    // }
    ...
    function initGoogleMap() {
        var map;
        if ($("#map").length) {
            var center = { lat: 49.2834141, lng: -123.1115295 };
            var styles = [{
                "featureType": "water",
